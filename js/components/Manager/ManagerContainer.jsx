        ...
        return (
            <div className="row">
                ...
                <div className='col'>
                    ...
                    <Route path='/manager/project_completed' render={() => <TasksCompleted tasksCompleted={this.props.tasksCompleted} />} />
                    <Route path="/manager/user" render={() => <Users />} />
                    <DataProvider>
                        <Route path="/manager/step1" render={() => <Step1 projects={this.props.projects} country={this.state.country} user={this.props.user} users={this.props.users} languages={this.props.languages}/>} />
                        <Route path="/manager/step2" render={() => <Step2 projects={this.props.projects} />} />
                        <Route path="/manager/result" render={() => <ResultHook projects={this.props.projects} user={this.props.user} />} />
                    </DataProvider>
